...
def print_hyperedge(h_edge, hg):
    ...
    print("Hyperedge: NAME: "+str(hg.get_hyperedge_attribute(h_edge,'name'))+" TAIL: "+str(hg.get_hyperedge_tail(h_edge))+" ++ HEAD: "+str(hg.get_hyperedge_head(h_edge))+" ++ phero: "+str(hg.get_hyperedge_attribute(h_edge, 'phero')))